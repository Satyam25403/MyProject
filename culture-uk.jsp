...
<head>
  ...
  <title>culture uk</title>
  <link rel="stylesheet" href="styles/culture-uk.css">
</head>
<body>
  <header class="head">
  ...
  <div class="content-wrapper">
    <aside>
      ...
      <ul class="menubar">
        <li><a href="#d1">Attire</a></li>
        <li><a href="#d2">Cuisine</a></li>
        <li><a href="#d3">Traditional Customs</a></li>
        <li><a href="#d4">Language</a></li>
        <li><a href="#d5">Festivals</a></li>
      </ul>
      
    </aside>
    <main>
      <div class="d1" id="d1">
        <h2>ATTIRE OF UTTARAKHAND</h2>
        <p>Uttarakhand or better known among the natives as Uttaranchal is famous across India for its holy places. This Devbhoomi (Land of Gods) is situated in the mountainous region of the Himalayas and is also a popular tourist destination.
...
A married woman was supposed to wear hansuli (silver ornament) worn around the neck, guloband (resembles the contemporary choker), black beads and silver necklace called chareu, silver payal, silver necklace, silver dhagula (bracelet) and bichuye (toe rings). Sindoor along with bindi was also mandatory for a married woman. Even today, a Gulaband is a distinct feature of a married woman. It is designed on a maroon or blue band with gold square pieces arranged on it.
          ...
          <h4>Hansuli</h4>
          <p>A woman wearing a gold bulaq on her nose. Traditionally, a newly married woman was expected to wear a big gold septum ring called bulaq. It was given as a dowry by the bride's family. Weddings are a significant event in this community. The bride dons a red ghaghra with a big nath (nose ring), maang teeka, bulaq, guloband, kamar bandh (silver) among others, all made from gold.   </p>
        <img src="">
           <h3>Men's Traditional Attire</h3>
           <p>Garhwali men usually wear kurta and pyjama or kurta and churidar, depending on their age. This is the most common attire in the community. This is paired with a topi by the young or pagadi by the older men to protect themselves from the cold. A lot of men also started wearing suits after the influence of the British. The fabric used for clothes differs according to the region's weather conditions, wool in colder regions and cotton in warmer regions.
...
<img src="">
           <h2>Kumaoni Traditional Dresses</h2>
           <h3>Women's Traditional Attire</h3>
           <p>The women in the Kumaon region of Uttarakhand can usually be found wearing a ghagra along with a kameez (shirt) as a blouse. This closely resembles the attire worn by many Rajasthani women. Kumaoni women also wear pichoras, a type of garment common during weddings and ceremonies. Traditionally this was dyed and made at home and was yellow. Even today, women don this traditional pichora on their wedding day.
...
<img src="">
            <h3>Men's Traditional Attire</h3>
            <p>The regular clothes of the men of Kumaon region resemble that of Garhwali. They too wear kurta and pyjama along with a turban or topi. However, they can be found wearing jewellery on their necks or hands. Something which is specific to the Kumaon region.</p>
            <h2>Traditional Attire of the Tribal Community</h2>
            <p>Uttarakhand is home to mainly five tribes as per the 2001 Census, which are Tharu, Jannsari, Buksa, Bhotia, and Raji. These mostly reside in rural areas except the Bhutia tribe (25.8%) which is also quite prominent in urban areas. Majority of the tribal population is concentrated in the Pithoragarh district and Udham Singh Nagar in Kumaon division and Dehradun and Chamoli district of Garhwal division. </p>
            <h3>Jaunsaris</h3>
            <p>Jaunsaris claim themselves to be the descendants of Pandavas of Mahabharat. They have a distinct style of clothing which is very colourful and involves a lot of jewellery, making them stand apart from their Garhwali neighbours. Even the men wear jewellery like earrings, kadas, necklaces, etc. along with a traditional cap called digwa made from woollen cloth. Women wear a ghagra, a woollen coat, and dhantu (scarf). During festivals, they wear Thalka or Lohiya, which is a long coat.</p>
            <h3>Bhotia</h3>
...
<img src="">
             <p>With the onset of westernisation and modernisation, a lot of changes have taken place in the clothing patterns of the people of Uttarakhand.
...
<div class="d2" id="d2">
                <h2>CUISINES OF UTTARAKHAND</h2>
                <p>Cuisines of Uttarakhand are simple and made of locally grown ingredients. The cuisines don't have complex spices. The two regions in Uttarakhand have different cuisines, the Garhwali Cuisines and Kumaoni Cuisines. Some popular dishes of Uttarakhand cuisine are:</p>
                <h3>Rabri (that made with Jhongora (shyama ka chawal) & Chaas (butter milk) adding leaves of Radish.)</h3>
                <p>Rabri is a traditional Indian dessert made by slowly simmering full-fat milk until it thickens and reduces, forming layers of cream (malai). It is sweetened with sugar and flavored with cardamom, saffron, and sometimes rose water. Nuts like almonds and pistachios are often added as garnish.  </p>
                <h4>Key Features:  </h4>
                <p>- Texture: Thick and creamy with layers of malai.  
- Flavor: Sweet, with subtle hints of cardamom and saffron.  
- Served: Usually chilled, as a dessert or accompaniment to sweets like jalebi or malpua.  
Rabri is popular across India, especially in northern regions, and is often prepared for festivals and special occasions.
</p>
<img src="">
                <h3>Khadi or jhwāi (made with Curd or buttermilk)</h3>
                <p>Khadi and Jhwayi are traditional fermented foods commonly consumed in the Kumaon and Garhwal regions of Uttarakhand. They are simple, nutritious dishes with cultural significance.  </p>
                <h4>Khadi  </h4>
                <p>-Description: A thin curry made from buttermilk or curd, thickened with gram flour (besan), and flavored with turmeric, garlic, and spices.  
- Serving: Typically served with steamed rice.  
- Significance: A staple comfort food in Uttarakhand, especially during winters.
</p>
<img src="">
                <h4>Jhwayi</h4>
                <p>- Description: A rice-based dish prepared by fermenting cooked rice and water overnight, often mixed with buttermilk or curd.  
- Usage: Eaten for its cooling properties and probiotic benefits.  
- Cultural Note: It’s a traditional food among farmers, providing energy and aiding digestion.  
</p>
<img src="">
                <h3>Arsa (made with rice and jaggery):</h3>
                <p>Arsa is a traditional sweet delicacy from Uttarakhand, often prepared during festivals, weddings, and special occasions. It is simple yet rich in taste, showcasing the culinary heritage of the region.  </p>
                <h3>Key Features:  </h3>
                <h4>1.Ingredients:  </h4>
                <p> Rice flour  
    Jaggery (gud)  
    Mustard oil or ghee (for frying)  
                ...
                <h4>2. Preparation:  </h4>
                <p> A dough is made by mixing rice flour with jaggery syrup.  
   - Small portions are shaped into flat rounds or balls and deep-fried in oil or ghee until golden brown.  
</p>
                <h4>3. Taste:  </h4>
                <p>  Sweet, with a slight crunch on the outside and softness inside.  </p>
                <h4>4. Significance:  </h4>
                <p> Symbolizes simplicity and purity.  
   Commonly offered as prasad(religious offering) or shared among family and friends during celebrations.  
Arsa reflects Uttarakhand’s reliance on locally available ingredients and its emphasis on sustainable, wholesome cooking.
</p>
<img src="">
                <h3>-Gulthiya (made with normal atta & pure desi Ghee)</h3>
                <p>Gulthiya is a traditional dish from Uttarakhand, particularly popular in the Kumaon region. It is a simple yet flavorful preparation made using wheat flour dumplings cooked in a mildly spiced curry or gravy.</p>
                <h3>Key Features:</h3>
                <h4>1. Ingredients:  </h4>
                <p>Wheat flour (for making the dumplings)  
    Curd or buttermilk  
    Turmeric, garlic, and other spices for the gravy  
    Mustard oil for cooking  
</p>
                <h4>2. Preparation:  </h4>
                <p> A dough is prepared from wheat flour, shaped into small dumplings, and boiled.  
    These dumplings are then cooked in a tangy curd-based gravy, seasoned with turmeric, garlic, and spices.  
</p>
                <h4>3. Taste:  </h4>
                <p>Tangy and mildly spiced, with soft dumplings absorbing the flavors of the gravy</p>
                <h4>4. Serving:  </h4>
                <p> Typically enjoyed with steamed rice.  </p>
                <h4>5. Significance:  </h4>
                <p> A comfort food in the region, often prepared during cold weather due to its warming and nutritious qualities.  
Gulthiya showcases the simple, wholesome, and resourceful culinary traditions of Uttarakhand
</p>
<img src="">
                <h3>Garhwal ka Fannah:</h3>
                <p>Garhwal ka Fannah is a popular and flavorful dish from the Garhwal region of Uttarakhand, known for its rich taste and simplicity. It is a lentil-based curry that highlights the local culinary style.</p>
                <h3>Key Features:</h3>
                <h4>1. Ingredients:  </h4>
                <p> Black gram lentils (urad dal) or split green gram lentils (moong dal)  
   Spices like turmeric, coriander, cumin, and red chili  
    Ghee or mustard oil for tempering  
</p>
                <h4>2. Preparation:  </h4>
                <p> Lentils are cooked until soft and then simmered with spices and a generous tempering of ghee or oil.  
    Garnished with coriander leaves for added flavor.  
</p>
                <h4>3. Taste:  </h4>
                <p>   Rich, earthy, and mildly spiced, with a creamy texture.  </p>
                <h4>4. Serving:  </h4>
                <p>   Typically served with steamed rice or roti.  </p>
                <h4>5. Significance:  </h4>
                <p> A traditional dish that reflects the simplicity and nutrition-focused diet of the Garhwal region.  
   Commonly prepared during festivals, family gatherings, or as comfort food.  
Garhwal ka Fannah is a testament to Uttarakhand's emphasis on wholesome, hearty meals made from locally sourced ingredients.
</p>
<img src="">
               <h3>Muspani(Grounded urad):</h3>
               <p>Muspani, a traditional dish from Uttarakhand, is made using ground urad dal (black gram) and is cherished for its rich flavor and cultural significance. It is especially popular in the Kumaon and Garhwal regions.</p>
               <h3>Key Features:</h3>
               <h4>1. Ingredients:  </h4> 
               <p> Urad dal (black gram), soaked and ground into a paste  
   Spices like turmeric, cumin, coriander, and red chili  
   Ghee or mustard oil for cooking  
</p>
              <h4>2. Preparation:  </h4>  
              <p>The soaked urad dal is finely ground and then shaped into small balls or patties.  
   These are cooked or fried and simmered in a spicy curry, often made with curd or buttermilk for tanginess.  
</p> 
               <h4>3. Taste:  </h4> 
               <p> Rich and earthy, with a slightly nutty flavor from the black gram.  </p>      
               <h4>4. Serving:  </h4>
               <p>Usually enjoyed with steamed rice or mandua (finger millet) roti.  </p>
               <h4>5. Significance:  </h4>
               <p> A nutritious dish, high in protein and energy, making it ideal for the colder climate of Uttarakhand.  
    Often prepared during festivals or special occasions.  

Muspani reflects the resourcefulness of Uttarakhand’s traditional cooking, making the most of simple, locally available ingredients to create hearty, satisfying meals.
</p>
<img src="">
                <h3>Dhapadi(Spinach soup):</h3>
                <p>Dhapadi is a traditional spinach-based soup from Uttarakhand, known for its vibrant green color and rich, earthy flavors. It is made using fresh spinach and a blend of spices, offering a nutritious and comforting dish, especially during the colder months.</p>
                <h3>Key Features:</h3>
                <h4>1. Ingredients:  </h4>
                <p>- Fresh spinach leaves (or sometimes a mix of spinach and other greens like mustard or fenugreek)  
   - Garlic, ginger, cumin, and black pepper for flavor  
   - Mustard oil or ghee for tempering  
   - Yogurt or cream for richness and tanginess  
   - Salt and turmeric for seasoning  
</p>
                 <h4>2. Preparation:  </h4>
                 <p> The spinach is washed and cooked until soft.  
   It is then blended into a smooth paste.  
    A tempering (tadka) of garlic, cumin, and spices is prepared and added to the spinach mixture.  
    The soup is simmered with yogurt or cream, giving it a smooth and velvety texture.  
</p>
                 <h4>3. Taste:  </h4>
                 <p>The soup is flavorful, mildly spicy, and rich, with the earthy taste of spinach balanced by the creaminess of the yogurt or cream. </p>
                 <h4>4. Serving:  </h4>
                 <p>Dhapadi is typically served hot, often accompanied by steamed rice or as a side dish with roti.  </p>
                 <h4>5. Significance:  </h4>
                 <p>- A healthy and energizing soup, it is especially popular in the colder months when spinach is in season.  
   - Its a staple comfort food in Uttarakhand, offering warmth, nourishment, and a connection to the region’s traditional agricultural produce.
Dhapadi reflects Uttarakhand’s emphasis on using local, fresh ingredients to create hearty and nutritious meals that are ideal for the mountainous region.
</p>
<img src="">
                 <h3>Rasmi Badi (Kofta)</h3>
                 <p>Rasmi Badi (Kofta) is a popular traditional dish from the Kumaon region of Uttarakhand. It is a flavorful preparation made from fried lentil dumplings (badi) that are cooked in a rich, spicy gravy. The dish is often served as a main course, typically with rice or roti.</p>
                 <h3>Key Features:</h3>
                 <h4>1. Ingredients:</h4>
                 <p>Badi (lentil dumplings): Made from ground urad dal (black gram) or chana dal (gram lentils), mixed with spices like cumin, coriander, turmeric, and red chili powder.
   Gravy: Prepared with ingredients like onions, tomatoes, ginger, garlic, and spices such as cumin, garam masala, turmeric, and red chili.
    Mustard oil: Often used for tempering and frying, adding a distinct flavor.
    Fresh coriander: Used as a garnish.
</p>
                 <h4>2. Preparation:</h4>
                 <p>- The badi (lentil dumplings) are prepared by soaking the lentils, grinding them, and then shaping them into small balls or patties. These are deep-fried until golden and crispy.
   - The gravy is made by sautéing onions, tomatoes, and spices, creating a thick, flavorful base.
   - The fried lentil dumplings (badis) are then added to the gravy and allowed to simmer, absorbing the rich flavors.
   - The dish is garnished with fresh coriander before serving.
</p>
                 <h4>3. Taste:</h4>
                 <p>Rasmi Badi (Kofta) has a balanced flavor profile: the dumplings are savory, slightly crispy on the outside, and soft on the inside, while the gravy is aromatic, mildly spicy, and rich.</p>
                 <h4>4. Serving:</h4>
                 <p>It is typically served with steamed rice or roti.
   It can also be paired with flatbreads like mandua roti (made from finger millet flour), popular in Uttarakhand.
</p>
                 <h4>5. Significance:</h4>
                 <p>- Rasmi Badi is a beloved dish in Uttarakhand, often prepared during festivals, special occasions, or family gatherings.
   - The use of locally sourced lentils and the unique flavor from mustard oil make it a staple in the traditional cuisine of the region.
This dish combines the heartiness of lentils with the depth of flavors from the rich, spiced gravy, making it a wholesome and comforting meal in Uttarakhand’s culinary tradition.
</p>
<img src="">
                 <h3>Aloo Ke Gutke</h3>
                 <P>Aloo Ke Gutke is a traditional and flavorful dish from Uttarakhand, particularly popular in the Garhwal and Kumaon regions. It is a simple yet spicy potato preparation that is often served as a side dish or snack. </p>
                 <h3>Key Features:</h3>
                 <h4>1. Ingredients:  </h4>
                 <p>Potatoes (boiled and cut into chunks or cubes)  
   Mustard oil  
   Spices like cumin, coriander powder, turmeric, red chili powder, and asafoetida (hing)  
   Fresh coriander leaves for garnish  
   Salt to taste  
</p>
                  <h4>2. Preparation:  </h4>
                  <p>The boiled potatoes are cut into chunks and lightly crushed or smashed, allowing them to absorb the spices.  
   In a pan, mustard oil is heated, and cumin seeds are added for tempering.  
   Spices like red chili powder, turmeric, and coriander powder are added and cooked briefly.  
   The boiled potatoes are then added to the pan and cooked with the spices, stirring until the potatoes are well-coated and the flavors are absorbed.  
   The dish is garnished with fresh coriander leaves.
</p>
                  <h4>3. Taste:  </h4>
                  <p>Aloo Ke Gutke has a bold, spicy, and tangy flavor due to the combination of mustard oil and the various spices.  
   The potatoes are crispy on the outside and tender on the inside.
</p>
                  <h4>4. Serving:  </h4>
                  <p>Typically served as a side dish with roti or rice.  
   It is also popular as a snack or for breakfast with a cup of chai.
</p>
                  <h4>5. Significance:  </h4>
                  <p>Aloo Ke Gutke is a beloved comfort food in Uttarakhand, especially in rural areas, due to its simplicity, heartiness, and use of locally available ingredients.  
   It is a quick and flavorful dish that reflects the region's love for using mustard oil and spices in everyday cooking.
This dish captures the rustic and flavorful essence of Uttarakhand's traditional cuisine, making use of minimal ingredients to create a satisfying and aromatic dish.
</p>
<img src="">
                  <h3>Rotna</h3>
                  <p>Rotna is a traditional dish from the Garhwal and Kumaon regions of Uttarakhand, often prepared during festivals, special occasions, or as a comforting meal. It is a type of flatbread made from rice flour and is commonly served with a variety of vegetable dishes or chutneys.</p>
                  <h3>Key Features:</h3>
                  <h4>1. Ingredients:</h4>
                  <p>Rice flour (main ingredient)
   Water
   Salt (optional, for flavor)
   Sometimes, a little ghee or oil for extra softness
</p>
                  <h4>2. Preparation:</h4>
                  <p>- The rice flour is mixed with warm water and kneaded into a smooth dough.
   - The dough is divided into small balls and rolled out into flat discs or round shapes, similar to other types of Indian flatbreads like chapati or roti.
   - These discs are then roasted on a hot griddle (tava) until they turn golden brown and crispy. Some variations include cooking them in ghee or oil to enhance flavor.
   - Once cooked, the rotna is served hot.
</p>
                  <h4>3. Taste:</h4>
                  <p>Rotna has a soft and slightly chewy texture when freshly made. It’s more neutral in flavor compared to wheat-based breads, making it perfect for pairing with spicy or tangy vegetable curries.</p>
                  <h4>4. Serving:</h4>
                  <p>Typically served with dal (lentils), vegetable curries, or chutneys.
   Can also be enjoyed with yogurt or pickles, making it a versatile and satisfying dish.
</p>
                  <h4>5. Significance:</h4> 
                  <p>Rotna is a staple in Uttarakhand's traditional diet, especially in rural areas where rice is a common crop.
  It’s especially popular during festivals or in colder months because it provides warmth and sustenance.
This simple and nutritious dish showcases the use of locally available ingredients like rice flour, making it an important part of the cultural and culinary traditions of Uttarakhand.
</p> 
<img src="">  
<div class="d3" id="d3">
<h2>TRADITIONAL CUSTOMS OF UTTARAKHAND</h2>
              <p>Uttarakhand, often referred to as Devbhoomi (Land of Gods), is known for its rich cultural heritage and traditional customs. Here are some key traditional customs of the state:</p>
              <h3>1. Festivals and Celebrations  </h3>
              ...
              color: inherit;           
              font-family: inherit;">
                - Phool Dei: A harvest festival celebrating the arrival of spring, where young girls decorate doorsteps with flowers and offer sweets.  
                - Harela: Celebrated to mark the onset of the monsoon and sowing season; saplings are planted as part of the tradition.  
                - Kauthig (Fairs): Large regional fairs, like Nanda Devi Mela and Jauljibi Mela, celebrate local deities and community gatherings.  
                - Bhitauli: A festival where brothers give gifts to their sisters, symbolizing familial bonds.  
             </pre> 
              <h3>2. Folk Music and Dance  </h3> 
              <pre style="display: block;        
              margin-top: 1em;      
              margin-bottom: 1em;  
              margin-left: 0;        
              ...
              color: inherit;           
              font-family: inherit;">
                - Chholiya Dance: A traditional sword dance performed during weddings, especially in the Kumaon region.
                - Jagars: A ritualistic form of folk music used to invoke deities and spirits.  
                - Ramlila Performances: Theatrical depictions of the Ramayana, performed during festivals.  
              </pre>
              <img src="">
              ...
              color: inherit;           
              font-family: inherit;">
                - Ganesh Puja: A mandatory pre-wedding ritual seeking blessings for a successful marriage.  
                - Chholiya: The groom’s procession is accompanied by sword dancers and traditional music. 
              </pre>
              <h3> 4. Religious Practices </h3> 
              <pre style="display: block;        
              margin-top: 1em;      
              margin-bottom: 1em;  
              margin-left: 0;        
              ...
              color: inherit;           
              font-family: inherit;">
                - Jagar Ceremonies: Spiritual rituals involving trance states to communicate with deities or ancestors.  
                - Kumbh Mela: A massive spiritual gathering in Haridwar every 12 years.  
                - Char Dham Yatra: Pilgrimage to Yamunotri, Gangotri, Kedarnath, and Badrinath, significant in Hinduism. 
              </pre>
              <h3>5. Cuisine Traditions  </h3>
              <pre style="display: block;        
              margin-top: 1em;      
              margin-bottom: 1em;  
              margin-left: 0;        
              ...
              color: inherit;           
              font-family: inherit;">
                - Festivals and religious ceremonies often include offerings like jhangora kheer (millet pudding) and singal (sweet fried bread).  
                - Food is prepared with a focus on local ingredients, such as mandua (finger millet) and bhatt (black soybeans).
              </pre>
              <h3>6. Clothing and Ornaments  </h3>
              <pre style="display: block;        
              margin-top: 1em;      
              margin-bottom: 1em;  
              margin-left: 0;        
              ...
              color: inherit;           
              font-family: inherit;">
                - Traditional Attire: Women wear ghagra-choli with a long pichora (veil), while men wear kurta and pyjama or dhotis.  
                - Jewelry: Nose rings (nath), necklaces (gulband), and silver ornaments hold cultural significance.  
                </pre>
             <h3>7. Panchayat System  </h3>
             <pre style="display: block;        
             margin-top: 1em;      
             margin-bottom: 1em;  
             margin-left: 0;        
             ...
             color: inherit;           
             font-family: inherit;">
                - Local governance involves community elders resolving disputes and making decisions based on traditional norms.
                </pre>
              <h3>8. House and Lifestyle </h3>
              <pre style="display: block;        
              margin-top: 1em;      
              margin-bottom: 1em;  
              margin-left: 0;        
              ...
              color: inherit;           
              font-family: inherit;">
                - Traditional houses are made of stone and wood, often with sloping roofs to withstand the cold and monsoons.  
                - Seasonal festivals align with agricultural activities, emphasizing harmony with nature.  
              </pre>
              <p>Uttarakhand's customs are deeply rooted in its natural environment, religious beliefs, and agrarian lifestyle, reflecting the state's profound cultural and spiritual essence.</p>
        </div>   
        <div class="d4" id="d4">
            <h2>LANGUAGE OF UTTARAKHAND</h2>
            <p>The common languages spoken in Uttarakhand are:  
                Here is a brief overview of the languages commonly spoken in Uttarakhand:</p>
                <h3>1. Hindi</h3>
                <pre style="display: block;        
              margin-top: 1em;      
              margin-bottom: 1em;  
              ...
              color: inherit;           
              font-family: inherit;">
              - Significance: The official language of Uttarakhand and widely spoken across the state.  
              - Usage: Common in administration, education, and daily communication, especially in urban areas.
            </pre>
            <h4>History:</h4>
            <p>
            ...
            <pre style="display: block;        
              ...
              color: inherit;           
              font-family: inherit;">
              - Region: Spoken primarily in the Garhwal region.  
              - Features: A Central Pahari language with a rich oral tradition of folk songs and stories.  
              - Current Status: Facing decline as younger generations shift to Hindi.
             </pre>
             <h4>History</h4>
             <p>
                ...
                The earliest form of Garhwali can be traced to the 10th century, found in numismatics, royal seals, inscriptional writings on copper plates and temple stones containing royal orders and grants. One example is the temple grant inscription of King Jagatpal at Dev Prayag in 1335 CE. Most Garhwali literature is preserved in folk form, passed down orally. However, since the 18th century, Garhwali has developed a literary tradition. Until the 17th century, Garhwal was always a sovereign nation under the Garhwali Kings. Naturally, Garhwali was the official language of the Garhwal Kingdom.
             </p>
             <h3>3. Kumaoni</h3>
             <pre style="display: block;        
             margin-top: 1em;      
             ...
             color: inherit;           
             font-family: inherit;">
             - Region: Predominantly spoken in the Kumaon region.  
             - Features: Another Central Pahari language with its own dialectal variations.  
             - Cultural Importance: Known for its traditional songs and folklore.
             ...
             color: inherit;           
             font-family: inherit;">
                - Region: Spoken in the Jaunsar-Bawar area near Dehradun.  
                - Features: A unique dialect with elements of both Pahari and North Indian languages.  
                - Cultural Note: Associated with the distinct customs and traditions of the Jaunsari community.
             </pre>
             <h3>5. Bhotiya</h3>
             <pre style="display: block;        
             margin-top: 1em;      
             ...
             color: inherit;           
             font-family: inherit;">
                - Region: Found in the northern Himalayan regions, especially near the Indo-Tibetan border.  
                - Features: Influenced by Tibetan and Himalayan languages.  
                - Speakers: Primarily the Bhotiya tribal community.  
             </pre>
             <p>The Bhotiyas of Himachal Pradesh and Uttarakhand identify as Raghuvanshi Rajput and prefer to be referred as Thakur or Rajvanshi. The Bhotiya may be the original immigrants to north Oudh in the period of Nawab Asaf-Ud-Dowlah (1775 to 1797).</p>
             <h4>History:</h4>
             <p>
                The Bhotiya people are closely related to several other groups and ethnic boundaries are porous. 56  One group is the Bhutia, the main ethnolinguistic group of the northern part of the Indian state of Sikkim. A second is the Uttarakhand Bhotiya of the upper Himalayan valleys of the Kumaon and the Garhwal divisions of Uttarakhand. These include the Shauka tribe of Kumaon, the Tolchhas and the Marchhas of Garhwal, Gyagar Khampa of Khimling, Bhidang. A third related group are the Dzongkha speaking Ngalop people, the main ethnolinguistic group of Bhutan. The Bhotiya are also related to several dispersed groups in Nepal and the adjacent areas of India including the Tibetans and Sherpas.
             </p>
             <p>
             ...
             color: inherit;           
             font-family: inherit;">
                - Region: A rare language spoken in remote parts of the state by some tribal communities.  
                - Features: Considered endangered due to a small number of speakers. 
             </pre>
             <p>
             ...
             color: inherit;           
             font-family: inherit;">
                - Region: Commonly spoken in areas with Punjabi migrant populations.  
                - Features: Result of historical migration and settlement, particularly in urban and agricultural areas.  
             </pre>
             <h3>8. English</h3>
             <pre style="display: block;        
             margin-top: 1em;      
             ...
             color: inherit;           
             font-family: inherit;">
                - Significance: Used for education, official work, and communication in urban regions.  
                - Usage: Often paired with Hindi for administrative purposes and in tourism.  
             </pre>
        </div>
        <div class="d5" id="d5">
            <h2>Festivals of uttarakhand:</h2>
            <h3>1)Dehradun Literature Festival</h3>
            <p>The Dehradun Literature Festival is an annual literary festival held in Dehradun, Uttarakhand, India, which began in 2017.[1] The festival hosts authors, poets, artists, filmmakers, and scholars who participate in discussions, workshops, and book launches, focusing on literature and cultural dialogue</p>
            <h4>History</h4>
            <p>
            ...
            <h4>Significance and Celebration in Kumaon</h4>
            <p>
            ...
            <h4>Traditions of Harela festival in Kumaun </h4>
            <p>
            ...
            <img src="" alt="">
            <h4>Spiritual Beliefs Associated with Uttarayani</h4>
            <p>
            ...
            <p>
                The Bissu Mela is celebrated by the Jaunsari tribe of Chakrata Tehsil to pay gratitude for a good harvest season.Locals and the people from the vicinage come together and pray to the Santoora Devi, the incarnation of divinity Durga and offer her the rhododendron flowers.
            ...
            <img src="" alt="">
            <h3>8)Kanwar Yatra:</h3>
            <h4>About Kanwar Yatra</h4>
            <p>
            ...
            <h4>Highlights of Kanwar Yatra</h4>
            <p>
