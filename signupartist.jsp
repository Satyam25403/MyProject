...
<html>
    ...
    <label for="State">State:</label><br><br>
            ...
            <div class="input-group">
                ...
                <input type="text" name="securityquestion" placeholder="ex:Your pet name?" required>
                <label for="securityquestion">Add a security question</label>
            </div>

            <div class="input-group">
                <i class="fas fa-chain-broken"></i>
                <input type="text" name="answer" placeholder="Answer your question" required>
                <label for="answer">Answer security question</label>
            </div>
