...
<html lang="en">
<head>
  <link rel="stylesheet" href="styles/culture-ap.css">
  <meta charset="UTF-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <title>Culture-AP</title>
  ...
  <div class="content-wrapper">
    <aside>
      ...
      <ul class="menubar">
        ...
        <li><a href="#d2">Social Customs</a></li>
        <li><a href="#d3">Cuisine</a></li>
    ...
    <main>
      ...
      <div class="d1" id="d1">
        ...
        <h2>Attire</h2>
        <p>Andhra Pradesh is home to some of the finest historical cloth-making, fashion and dying traditions of the world. Its rich cotton production, with its innovative plant dye extraction history stand next to its diamond mining, pearl harvesting and jewelry traditions to form an impressive fashion tradition that has stood the test of time. The ancient Kollur mine is the mother of the numerous legendary gems such as the Koh-i-Noor and Hope Diamond. Andhra Pradesh had a virtual monopoly in the global jewelry industry till 1826 (founding of the diamond mines in Rhodesia, Africa) and eight of the ten most valuable jewelry pieces on earth today trace their history back to Andhra Pradesh. Langa-Voni (Half saree), Sarees made in Kalamkari, Venkatagiri are the result of this 3000-year-old fashion tradition. Vaddaanam, Aravanke, Kashulahaaram, Buttalu and various standard gold jewelry designs are fine examples of this continuously evolving ancient tradition.
            The attire of Andhra Pradesh reflects the region's rich cultural heritage and traditions, influenced by its climate, festivals, and social practices. Here's an overview of traditional clothing from Andhra Pradesh:
            </p>
        <h3>Men:</h3>
        <h4>1. Dhoti (Panche or Lungi):  </h4>
        <p>- A long, unstitched rectangular cloth wrapped around the waist and legs.</p>
        <p>- Often made of cotton or silk, with zari borders for festive occasions.</p>
        <p>- Sometimes paired with a kurta or angavastram (shawl).</p>
        <h4>2. Kurta and Pajama:   </h4>
        <p>- Lightweight kurtas, paired with pajamas or dhotis, are common for casual and formal wear.</p>
        <h4>3. Sherwani:  </h4>
        <p>- Worn during weddings or special events, often with intricate embroidery.</p>
        <h4>4. Uttariya (Shawl): </h4>
        <p>A cloth draped over the shoulders, especially during religious rituals.</p>
        <h3>Women:</h3>
        <h4>1. Saree (Cheera):    </h4>
        <p>- A six to nine-yard drape, often worn with a blouse and petticoat.  </p>
        <p>   - Mangalgiri, Venkatagiri, and Uppada sarees are famous for their handwoven designs.  </p>
        <p>silk sarees are also popular for weddings and festivals.</p>
        <h4>Half-Saree (Langa Voni):   </h4>
        <p>   - Traditional attire for young girls, consisting of a long skirt (langa), a blouse, and a draped dupatta (voni).</p>
        <h4>3. Salwar Kameez:   </h4>
        <p>Commonly worn by younger women for comfort and ease of move.</p>
        <h3>Jewelry and Accessories:</h3>
        <h4>1. Gold and Pearl Jewelry:</h4>
        <p>- Andhra Pradesh is known for its intricate gold designs and pearls from Hyderabad.</p>
        <h4>2. Bangles and Anklets:  </h4>
        <p>- Essential for women, symbolizing marital and festive celebrations.</p>
        <h4>3. Mangalsutra:</h4>
        <p>   - A sacred necklace worn by married women.</p>
        <h3>For Special Occasions:</h3>
        <h4>1. Bridal Wear:  </h4>
        <p>- Brides traditionally wear richly embroidered silk sarees, adorned with heavy gold jewelry.  </p>
        <p>   - Hair is decorated with flowers (like jasmine) and ornaments.</p>
        <img src="">
        <h4>2. Festive Attire: </h4>
        <p>- Men wear silk dhotis and kurtas, while women prefer sarees with zari or temple borders.</p>
        <img src="">
        <h4>3. Dance Costumes:  </h4>
        <p> - Kuchipudi dancers wear vibrant, stitched sarees that allow flexibility and highlight traditional motifs</p>
            
    </div>

      <div class="d2" id="d2">
        <h2>SOCIAL CUSTOMS</h2>
        <p>Andhra Pradesh, a culturally vibrant state, boasts a rich tapestry of social customs and traditions deeply rooted in its history, religion, and way of life. Here's an overview of the social customs of Andhra Pradesh:</p>
        <h3>1. Festivals and Celebrations</h3>
            <h4>Sankranti: </h4>
            <p>A major harvest festival celebrated with kite flying, decorating homes with rangoli (muggu), and cooking traditional dishes like Pongal. Cattle are also adorned and worshipped.</p>
            <h4>Ugadi: </h4>
            <p>  Marks the Telugu New Year. People prepare Ugadi Pachadi, a dish symbolizing life’s six flavors: sweet, sour, bitter, salty, tangy, and spicy.</p>
            <h4>Dasara (Dussehra): : </h4>
            <p>Celebrated with devotion and grandeur, including the worship of Goddess Durga.</p>
            <h4>Bathukamma: </h4>
            <p>A floral festival dedicated to Goddess Gauri, mainly celebrated by women in Telangana and parts of Andhra Pradesh.</p>
        <h3>2. Marriage Customs</h3>
        <h4>Arranged Marriages:  </h4>
        <p>  Family-arranged marriages are common, with horoscopes matched to ensure compatibility.</p>
        <h4>Pelli Sandadi (Pre-wedding Festivities):</h4>
        <p>Includes rituals like Snatakam (sacred thread ceremony for the groom) and Pendlikoothuru (beautification of the bride and groom).</p>
        <h4>Mangalsutra Ceremony:</h4>
        <p>The groom ties a sacred thread (mangalsutra) around the bride's neck, symbolizing their marital bond.</p>
        <h4>Talambralu:</h4>
        <p>A playful ritual where the couple showers each other with rice mixed with turmeric and kumkum.</p>
        <h3>3. Food and Hospitality</h3>
        <h4>Traditional Meals: </h4>
        <p>  Served on banana leaves during festivals and ceremonies, with dishes like Pulihora(tamarind rice), Gongura pachadi, and Pesarattu (moong dal dosa).</p>
        <h4>Hospitality: </h4>
        <p>Guests are considered divine and are welcomed with utmost respect </p>
        <h3>4. Religious Practices</h3>
        <h4>Temple Worship</h4>
        <p>  Visiting temples is integral, with rituals like Abhishekam (holy bath for idols) and Archana (chanting prayers for devotees).</p>
        <h4>Pilgrimages:</h4>
        <p>  Tirumala Venkateswara Temple in Tirupati is a major pilgrimage site.</p>
        <h4>Offering Prasadam:</h4>
        <p>Devotees offer food, fruits, and coconuts to deities, later distributed as prasadam.</p>
        <h3>5. Birth and Naming Ceremonies</h3>
        <h4>Seemantham (Baby Shower):  </h4>
        <p>ritual performed for pregnant women to seek blessings for safe childbirth.</p>
        <h4>Barasala (Naming Ceremony):  </h4>
        <p>Conducted on the 21st day after a child’s birth, where the baby's name is formally announced.</p>
        <h3>6. Death and Mourning Rites</h3>
        <h4>Antyeshti (Funeral Rites):  </h4>
        <p>Cremation is the common practice, followed by ceremonies like the Vaikunta Samaradhana (13th-day ritual).</p>
        <h4>Pind Pradanam: </h4>
        <p>rice balls (pind) to ancestors to ensure their soul's peace.</p>
        <h3>7. Arts and Entertainment</h3>
        <h4>Traditional Dances:  </h4>
        <p>, a classical dance form, and Perini Shivatandavam, a warrior dance.</p>
        <h4>Music and Folklore:  </h4>
        <p>  Devotional songs, Carnatic music, and folk art forms like Burrakatha are popular.</p>
        <h4>Handicrafts</h4>
        <p>Kalamkari paintings and Kondapalli toys play a significant role in local traditions.</p>
        <h3>8. Caste and Community Traditions</h3>
        <h4>Community Gatherings:</h4>
        <p>Villages have strong community ties, with elders resolving disputes through panchayats.</p>
        <h4>Caste-Specific Customs:</h4>
        <p>Each caste often follows unique rituals, particularly during weddings and festivals.</p>
        <h3>9. Social Structure and Values</h3>
        <h4>Respect for Elders:  </h4>
        <p>Touching elders' feet for blessings is a common practice.
        </p>
        <h4>Dowry System:</h4>
        <P>diminishing, dowry customs remain prevalent in some areas.</P>
        <h4>Joint Families:</h4>
        <p>While nuclear families are increasing, joint family systems are still valued in rural areas.</p>
      ...
      <div class="d3" id="d3">
        <h2>Cuisine</h2>
        <p>Andhra cuisine, culturally known as Telugu cuisine, is a cuisine of India native to the state of Andhra Pradesh and is the culinary style of Telugu people. It is generally known for its tangy, hot, and spicy taste.
        ...
        <p>A typical vegetarian meal in Andhra Pradesh.Vegetarian meal for a special occasion
            A vegetarian Andhra meal served on important occasions
            Coastal Andhra is dominated by the Krishna and Godavari river delta regions and is adjacent to the Bay of Bengal. This proximity to water has led to rice, lentils, and seafood becoming dietary staples in the region. Andhra cuisine has its own variations, but dishes are predominantly rice-based. The Nellore region in the south has its own unique recipes, markedly different from those in Uttarandhra. Ulava charu  is a soup made from horse gram,[1] and bommidala pulusu is a seafood stew that is considered a specialty of Andhra Pradesh. Andhra cuisine is prevalent in restaurants all over Andhra Pradesh, as well as in cities like Bangalore, Chennai, and New Delhi.
        ...
        <img src="">
        <p>-Dibba attu, a deep-fried dosa made with idli batter
            ...
            -Rava (Suji) dosa, a dosa made with sooji dough with chili, coriander leaves, onion, and pepper.
                ...
                <p>
                    ...
                    <img src="">
                <h4>upma</h4>
                <p>Godhuma uppindi, upma made from broken wheat flour.-Pesarpindi uppindi, a dry porridge made of green gram flour. Commonly served with yoghurt or mango-jaggery pickle.
                    ...
                    <h4>Vada</h4>
                    <p>-Garelu, a deep-fried lentil-based doughnut, or sometimes a deep-fried dal mixture.
                        ...
                        <h4>Atukulu/poha</h4>
                        <p>-Atukulu, also known as poha in the northern states; moist rice flakes sautéed in oil.
                            -Atukula dosa, dosa made from atukulu a.k.a. poha.
                            -Atukula upma, upma made from atukulu, replacing sooji with atukulu.
                            </p>
                            <h4>Bread and roti</h4>
                            <p>-Nokulu annam, made of jowar and jaggery.
                                ...
                                <p>Great effort is put into preparing lunch and dinner in many Telugu households. In most urban households, the food is served on stainless steel or porcelain plates, 	qqThe banana leaf is often used during festivals, special occasions, and for guests. Many middle-budget restaurants in smaller towns also use banana leaves for serving food. At times, a vistaraaku (a larger plate made of several leaves sewn together) is used. Sun-dried banana leaves have also traditionally been used to package food for personal use on long journeys.
                                    ...
                                    <h4>-Okra plain curry made in Vijayawada, Andhra Pradesh</h4>
                                    <img src="">
                                    <p>-Dried capsicum for chili dishes</p>
                                    <img src="">
                                    <h4>Meal presentation</h4>
                                    <p>Pappu (dal/lentils) and kooralu (curries) are placed to the right of the diner, while spiced pickles, pachadi (chutney/raita), a saucy condiment with dahi (yogurt), vegetables, pappulu podi (dal and dry red chili-based powdered condiment), and neyyi (ghee) are placed to the left. On some occasions, special items such as pulihora (tamarind or lemon rice) and garelu (vada) are placed at the top right. A large scoop of annam (plain white rice) is placed in the middle. Small amounts of neyyi are added on the rice. Avakaya (mango pickle) and gongura (roselle leaf pickle) are often served with the meal.</p>
                                    <h4>Courses and servings</h4>
                                    <p>Dibba rotti or minapa rotti is a classic Andhra dish eaten for breakfast, brunch, or evening snack with a chutney or pickle
                                        ...
                                        <h4>Koora/kura/curry (main courses)</h4>
                                        <p>-Pulihora , a sour tamarind-based fried rice dish from Andhra Pradesh</p>
                                        <img src="">
                                        <p>-Gobi Manchuria fry</p>
                                        <img src="">
                                        <p>-Banana with onion curry</p>
                                        <img src="">
                                        <h4>Koora </h4>
                                        <p>A generic word for a protein-based dish. Koora dishes are named for the ingredients used and the method of preparation. These methods include:
                                            ...
                                            <h4>Pulusu (sour paste or gravy)</h4>
                                            <p>Pulusu koora/Aava petti koora (stew): boiled vegetables cooked in tamarind sauce and mustard paste. Some varieties include potlakaya, anapakaya, bendakaya, gummadikaya.</p>
                                            <img src="">
                                            <p>Kaaram petti koora/Koora podi koora (literally, "dish with curry powder added"): sautéed vegetables cooked with curry powder or paste, served as a solid mass. The vegetables can be stuffed with curry powder or paste and are usually cooked whole.</p>
                                            <p>Ooragaya (pickle): avakaya, gongura, nimmakaya, etc.
                                                ...
                                                <p>Pulusu
                                                    ...
                                                    Mukkala pulusu or Dappalam: pulusu made with aanapakaya(bottle gourd) and other vegetables
                                                    ...
                                                    <p>While a sizeable portion of the Telugu-speaking population are vegetarian, the majority also consume non-vegetarian dishes. The state of Andhra Pradesh produces abundant seafood and has an established poultry industry. Lamb meat has also been consumed for centuries in the region. Andhra restaurant chains and hotels are very popular in other states due to the extensive variety of meat featured on their menus.
                                                        ...
                                                        <img src="">
                                                        <p>Endu chepala vankaya: a flavourful dry fish curry cooked with brinjal.
                                                            ...
                                                            These curries are usually served with steamed rice, Thalimpu annam (basmati rice cooked with aromatic seasoning), sajja roti (millet flatbread), or jonna roti (jowar flatbread).
                                                            Non-vegetarian snacks include kodi pakodi (chicken pakora), chicken 65, peetha pakodi (crab pakodi), chepa vepudu (fish fry), royyala vepudu (shrimp fry), and chicken lollipop.Bhimavaram town in West Godavari district is famous for its unique non-vegetarian pickles, such as chicken, shrimp, and fish pickles.The area near Rajamundry and Araku is famous for bongu (bamboo) chicken curry.
                                                            </p>
                                                            <h4>Snacks:</h4>
                                                            <p>Some common Telugu snacks include:
                                                                -Upma 
                                                                -Boondi -Kaarappoosa 
                                                                -Ponganalu -Bajji and bondaalu or punukulu ,stuffed with spices, dipped in chickpea batter and fried; served with a spicy dip (allam pachadi). Other varieties include mirapakaya bajji (chili), vamu bajji, vankaya bajji (brinjal), aratikaya bajji (plantain), urla gadda bajji (potato), and vegetable bonda.
                                                                </p>
                                                        <img src="">
                                                        <p>--Pakodi -Ulli kaadalu pakodi
                                                            Sanna pakodi
                                                            Vankaya pakodi
                                                            ...
                                                            Varieties include:perugu gaare/aavadalu , gaare marinated in a yogurt sauce, bellam garelu, rava garelu, ulli garelu, pulla garelu
                                                            Jantikalu -Varieties include pesarapappu jantikalu, challa murukulu, chegodilusakinalu or chakkidalu ,chakli, chekkalu or chuppulu , maida chips, molocasia chips, plain papadam, and aam papad
                                                        ...
                                                        <h4>Sweets and savories:</h4>
                                                        <p>Sweets and savories are typically made on festive and auspicious occasions, and are served to visiting relatives. Some of the savories below are also prepared as an evening snack.
                                                            ...
                                                            Poornam boorelu a.k.a. Poornalu, made by cooking chana dal until soft, cooling, then adding jaggery and cardamom powder. The mix is then rolled into balls, which are subsequently batter-fried. The batter that is used is made from urad dal. This sweet dish is usually served during a festival lunch.
                                                            
                                                          
                                                            Pulagam a.k.a. pongali, a sweet dish made on a festival morning as an offering for a deity. Soaked rice is cooked in milk at a ratio of 1:2.5; when the rice is cooked, well-broken jaggery is added. The dish is completed by adding a splash of ghee and fried dry fruit.
                                                            ...
                                                            Gavvalu or "sweet shells" , deep-fried and sugared balls of flour
      ...
      <div class="d5" id="d5">
        ...
        <p>Ugadi or Yugadi, also known as Samvatsarādi (meaning "beginning of the year"), is New Year's Day according to the Hindu calendar and is celebrated in the Indian states of Andhra Pradesh, Telangana and Karnataka.The cycle actually consists of 60 years, each year individually named. The first day of each year is called 'Ugadi'. The word Ugadi can be split into two: Uga means Course of Stars and Adi means Starting. It is festively observed in these regions on the first day of the Hindu lunisolar calendar month of Chaitra.This typically falls in late March or early April of the Gregorian calendar.It also falls during the Tamil month of either Panguni or Chithrai, sometimes on the day after Amavasya with 27th Nakshatra Revati.Ugadi day is pivoted on the first New Moon after March Equinox.  
          ...
          The pachadi is a notable festive food that combines all flavors – sweet, sour, salty, bitter, astringent and piquant. In Telugu and Kannada Hindu traditions, it is a symbolic reminder that one must expect all flavors of experiences in the coming new year and make the most of them.The same day is observed as a New Year by Hindus in many other parts of India, such as Gudi Padwa in Maharashtra, Goa and is a national public holiday in Mauritius.
          </p>
          <img src="">
          <h3>2.Rama Navami:</h3>
          <p>Rama Navami  is a Hindu festival that celebrates the birth of Rama, one of the most popularly revered deities in Hinduism, also known as the seventh avatar of Vishnu.He is often held as an emblem within Hinduism for being an ideal king and human through his righteousness, good conduct and virtue.The festival falls on the ninth day of the bright half (Shukla Paksha) of the lunar cycle of Chaitra (March–April), the first month in the Hindu calendar.It is also part of the Chaitra Navaratri festival in spring. Rama Navami is a holiday for government employees in India.
            ...
            <img src="">
            <h3>5.Navaratri:</h3>
            <p>Navaratri is an annual Hindu festival observed in honor of the goddess Durga, an aspect of Adi Parashakti, the supreme goddess. For Shaivites and Shaktas, Durga is a form or actually is Goddess Parvati. It spans over nine nights, first in the month of Chaitra (March/April of the Gregorian calendar), and again in the month of Ashvin (September–October).It is observed for different reasons and celebrated differently in various parts of the Hindu Indian cultural sphere. Theoretically, there are four seasonal Navaratris. However, in practice, it is the post-monsoon autumn festival called Sharada Navaratri. There are 2 Gupta Navaratris or "Secret Navaratris" as well, one starting on the Shukla Paksha Pratipada of the Magha Month (Magha Gupta Navaratri) and another starting in the Shukla Paksha Pratipada of Ashadha Month.
              Each day of Navaratri is dedicated to different forms of Goddess Durga, emphasizing themes of strength, prosperity, and knowledge.
              Temples are decorated beautifully, and grand pujas and aarti are performed, especially at prominent shrines like Kanaka Durga Temple in Vijayawada.
              In Andhra Pradesh, the nine days of **Navaratri** are dedicated to the worship of **Goddess Durga** in her nine forms, collectively known as the **Navadurga**. Each day corresponds to a specific avatar, with distinct significance and rituals.  
              </p>
            <img src="">
            <h3>6.Peerla Panduga:</h3>
            <p>Peerla Panduga is a mourning festival celebrated by Muslims in Telangana to remember the Battle of Karbala and in the Rayala Seema region of Andhra Pradesh, India,It is mourned across the Sufi shrines called Ashurkhana. A procession of the relic, called Alam is taken out as part of Muharram. There may be multiple relics donated by various members of the procession. Some villages in Telangana have relics that have been donated through generation by the members of the same family (Nasarla Palle, Telangana).
              Traditionally for many centuries, the Sunni Islamic scholars who are called "Islamic peers" would encourage their followers to organise programmes in remembrance of the martyrdom of Imam Hussain and his family members and friends and offer Salah and recite Quran and Hadith of the prophet Muhammad about the Ahl al-Bayt and mourn in silence and shed tears by remembering them (without self-flagellation) the day in which Yazeed ibn Muawiya happened to kill Imam Hussain (grandson of Muhammad).On this day, the Shia (followers of the Imam Hussain) mourn the martyrdom of him by self-flagellation.
            ...
            <p>Diwali , also called Deepavali (IAST: Dīpāvalī) or Deepawali (IAST: Dīpāwalī), is the Hindu festival of lights, with variations celebrated in other Indian religions such as Jainism and Sikhism. It symbolises the spiritual victory of Dharma over Adharma, light over darkness, good over evil, and knowledge over ignorance. Diwali is celebrated during the Hindu lunisolar months of Ashvin (according to the amanta tradition) and Kartika—between around mid-September and mid-November.
              ...
              <p>It is a Hindu, Sikh, and Jain cultural festival that is celebrated on purnima (full moon day), the 15th day of the lunar month Kartika. It falls on November or December of the Gregorian calendar and is also known as Tripurari Purnima or Deva-Deepavali, the gods's festival of lights. Karthika Deepam is a related festival that is celebrated in South India and Sri Lanka on a different date. It follows Diwali by about 15 days.
                In Telugu household of Andhra Pradesh , Karthika Maasamu (month) is considered very auspicious. The Kartika month starts on the day after Deepavali according to the (amanta tradition). From that day till the end of the month, oil lamps are lit every day. On Karthika Purnima, oil lamps with 365 wicks prepared at home are lit in Shiva temples. Apart from that, Kartika Puranam is read, and fasting is observed till sunset, every day for the whole month. The Swaminarayan Sampradaya also celebrates this day with faith and fervor.
                </p>
              <img src="">
              <h3>10.Makara Sankranti:</h3>
              <p>Sankranti, also known as Makara Sankranti, is one of the most celebrated harvest festivals in Andhra Pradesh. It marks the transition of the sun into the Makara Rashi (Capricorn), signifying the end of winter and the beginning of longer, warmer days. The festival typically takes place over three days in January and is filled with cultural, social, and spiritual significance.
                1. Three-Day Celebration
                The festival spans three days, each with distinct traditions:
                Bhogi (Day 1):
                A day to discard old things and embrace new beginnings.Families light Bhogi Mantalu, bonfires made of wood and agricultural waste, symbolizing purification.Homes are decorated with muggu (rangoli), enhanced with gobbemmalu (cow dung balls) and flowers.
                Makara Sankranti (Day 2):
                The main day of the festival dedicated to worship and gratitude.Farmers pray to the Sun God for a bountiful harvest.Families prepare festive dishes like arisa, sakinalu, pulihora, and bellam pongali (sweet rice with jaggery).
                Kanuma (Day 3):
                A day to honor and worship cattle, especially cows and bulls, for their contribution to agriculture.Farmers wash and decorate their animals with colorful ornaments and feed them special food
                Cultural and Festive Activities
                Kite Flying:
                The skies are filled with colorful kites as families and friends enjoy this traditional sport.
                Cockfights (Kodi Pandalu):
                Though controversial, cockfighting is a popular tradition in rural areas during Sankranti.
                Bull Races and Haridasu Performances:
                Haridasu singers visit homes, singing devotional songs and seeking alms.Bull races and village fairs are common.
                3. Traditional Foods
                Sankranti features a variety of traditional dishes made with newly harvested rice, jaggery, sesame seeds, and sugarcane.Popular dishes include garelu (vada), chakinalu, and sweet pongal.
                4. Decorations and Attire
                Women adorn their homes with elaborate muggu patterns and decorate entrances with mango leaf toranas.People wear new traditional attire—silk sarees for women and dhoti-kurtas for men.
                Significance
                Sankranti in Andhra Pradesh is a thanksgiving festival, celebrating the bond between humans, nature, and animals. It signifies prosperity, unity, and the joy of new beginnings, making it a cherished cultural tradition.
                </p>
              <img src="">
              <h3>11.Christmas:</h3>
              <p>
                Christmas, celebrated on December 25th, marks the birth of Jesus Christ and is a joyous occasion for the Christian community in Andhra Pradesh. The festival transcends religious boundaries, with people of all faiths joining in the celebrations.
                1. Religious Observances
                Midnight Mass:
                Churches across Andhra Pradesh, such as the Gunadala Matha Shrine in Vijayawada and St. Mary's Church in Visakhapatnam, host midnight mass and special services.Hymns, prayers, and readings from the Bible commemorate the nativity of Christ.
                Nativity Plays:
                Enactments of the birth of Jesus are performed, especially in schools and churches.
                2. Decorations
                Homes, churches, and public spaces are adorned with Christmas stars, decorative lights, and Christmas trees.
                Cribs (Nativity Scenes):
                Families and churches create detailed nativity scenes depicting the birth of Christ.
                3. Festive Food
                Traditional feasts include local specialties alongside Christmas treats like:Christmas plum cake Biryani, kachipudi chicken, and other savory dishes.Sweets like kajjikayalu, arisa, and boorelu are prepared in Christian households.
                4. Community Gatherings
                Caroling:
                Groups of carolers visit homes, spreading the Christmas spirit with songs and blessings.
                Charity:
                Many communities organize events to distribute food, clothes, and gifts to the underprivileged.
                 5.Public Celebrations
                Christmas fairs and markets are set up in towns and cities, selling decorations, gifts, and festive foods.Cities like Visakhapatnam and Hyderabad light up with special displays and events.
                Significance in Andhra Pradesh
                Christmas in Andhra Pradesh is a blend of faith, family, and festivity, bringing communities together. It reflects the universal values of love, compassion, and sharing, making it a cherished time of the year for all.
                </p>
              <img src="">
              <h3>12.Eid al-Fitr:</h3>
              <p>id al-Fitr is celebrated by Muslims worldwide because it marks the end of the month-long dawn-to-dusk fasting of Ramadan. Eid al-Fitr falls on the first day of Shawwal in the Islamic calendar; this does not always fall on the same Gregorian day, as the start of any lunar Hijri month varies based on when the new moon is sighted by local religious authorities. The holiday is known under various other names in different languages and countries around the world. The day is also known as the First Eid or as the Lesser Eid (Arabic: العيد الصغير, romanized: al-ʿĪd al-Ṣaghīr) by some Muslim communities.</p>
              <img src="">
              <h3>13.Rottela Panduga:</h3>
              <p>Rotiyaan Ki Eid or Rottela Panduga is an annual three-day festival held at Bara Shaheed Dargah in Nellore, Andhra Pradesh, India. The annual event is observed in the month of Muharram as the urs (death anniversary) of the 12 martyrs who are buried in the shrine. Women who visit the shrine exchange rotis in Nellore Tank</p>
              <img src="">
              <h3>14.Ramadan:</h3>
              <p>Ramadan(Arabic: رَمَضَان, romanized: Ramaḍān also spelled Ramazan, Ramzan, Ramadhan, or Ramathan) is the ninth month of the Islamic calendar, observed by Muslims worldwide as a month of fasting (sawm), prayer (salah), reflection, and community. A commemoration of Muhammad's first revelation, the annual observance of Ramadan is regarded as one of the Five Pillars of Islam and lasts twenty-nine to thirty days, from one sighting of the crescent moon to the next.
